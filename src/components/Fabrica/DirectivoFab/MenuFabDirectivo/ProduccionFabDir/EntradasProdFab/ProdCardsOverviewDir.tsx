import './ProdCardsOverviewDir.css';
...
export const ProdCardsOverviewDir: React.FC<Props> = ({filteredRecords, changeViewStatus}) => {
      ...
      <div className="crearReporteProdAdmin">
        <form className="cheese-categories-form">
          <div className="crear-reporte-queso-marco">
            ...
            <h3>{filteredRecords.quesoname}</h3>
            <h3 className="crear-reporte-queso-texto">Fecha de Entrada:</h3>
            <h3>{cleanedDate}</h3>
            <h4>Entrada Aprobada: </h4>
            <h4>{filteredRecords.approvepord}</h4>
            <h4 className="crear-reporte-queso-texto">Refrigeracion:</h4>
            <h4>{filteredRecords.refrigerationtype}</h4>
            <h4>No Piezas: {filteredRecords.nopieces}</h4>
            <h4>No Olladas: {filteredRecords.holladas}</h4>
            <h4>No Lote: {filteredRecords.lotenum}</h4>
